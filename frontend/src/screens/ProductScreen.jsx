...
// console check quantity in stock, check after loading the page
//console.log("check quantity in stock in the Productscreen.jsx: ", [...Array(product.countInStock).keys()]);
